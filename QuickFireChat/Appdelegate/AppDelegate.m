...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (![[GlobalUserDefaults getObjectWithKey:@"IsLoggedIn"] isEqual:[NSNull null]]) {
        ...
        if ( [[GlobalUserDefaults getObjectWithKey:@"IsLoggedIn"] isEqualToString:@"YES"]) {
            ...
            self.objModelUserInfo = [NSKeyedUnarchiver unarchiveObjectWithData:dictionaryData];
            
            self.navigationController = [MainStoryBoard instantiateInitialViewController];;
            
            DashboardVC *dashBoardVC=(DashboardVC *)[MainStoryBoard instantiateViewControllerWithIdentifier:@"DashboardVC"];
